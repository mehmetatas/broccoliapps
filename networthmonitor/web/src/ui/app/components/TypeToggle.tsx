    ...
    <div class="flex flex-col gap-1.5">
      ...
      <div class="flex">
        <button
          ...
          class={`flex-1 h-10 px-4 font-medium transition-colors border border-r-0 border-neutral-200 dark:border-neutral-700 rounded-l-lg ${
            value === "asset"
        ...
        <button
          ...
          class={`flex-1 h-10 px-4 font-medium transition-colors border border-neutral-200 dark:border-neutral-700 rounded-r-lg ${
            value === "debt"
