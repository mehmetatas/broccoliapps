...
type AuthCallbackProps = {
  onSuccess: (response: AuthExchangeResponse) => void;
  loadingContent?: ComponentChildren;
  errorContent?: (error: string) => ComponentChildren;
};

export const AuthCallback = ({ onSuccess, loadingContent, errorContent }: AuthCallbackProps) => {
