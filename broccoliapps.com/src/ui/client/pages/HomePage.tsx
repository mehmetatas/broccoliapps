  ...
  return (
    <div class="w-full">
      ...
      <section class="max-w-3xl mx-auto px-6 pt-16 pb-20 text-center">
        <h1 class="text-4xl sm:text-[2.75rem] font-bold mb-6 tracking-tight text-neutral-900 dark:text-neutral-200">
      ...
      {/* Philosophy */}
      <section class="max-w-3xl mx-auto px-6 pt-8 pb-16">
        <div class="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-8">
          ...
          <div>
            ...
            <p class="text-[0.95rem] text-neutral-500 dark:text-neutral-400">Skip a day. Skip a month. The app will be there when you need it, judgement-free.</p>
          </div>
          <div>
            <h3 class="text-base font-semibold mb-2 text-neutral-900 dark:text-neutral-200">Your data</h3>
            <p class="text-[0.95rem] text-neutral-500 dark:text-neutral-400">No selling to advertisers. No tracking across the web. Your information stays yours.</p>
          </div>
        </div>
      </section>
      ...
      {/* Apps */}
      <section
        class="bg-white dark:bg-neutral-800 border-y border-neutral-200 dark:border-neutral-700 py-20 px-4"
        id="apps"
      >
        <div class="max-w-[1100px] mx-auto">
          ...
          <div class="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8">
            {/* !tldr */}
            <div class="bg-neutral-50 dark:bg-neutral-900 rounded-xl px-4 py-8 border border-neutral-200 dark:border-neutral-700 transition-all hover:shadow-lg hover:shadow-black/5 dark:hover:shadow-black/30 hover:-translate-y-0.5">
              ...
              <div class="flex flex-col gap-3">
                <a href="https://www.nottldr.com" class="flex items-center justify-center gap-1.5 px-4 py-2 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-200 border border-neutral-300 dark:border-neutral-600 no-underline rounded-lg text-sm transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-700" target="_blank">
                  Web
                </a>
                <a href="https://apps.apple.com/au/app/tldr/id6757189366" class="flex items-center justify-center gap-1.5 px-4 py-2 bg-neutral-900 dark:bg-neutral-200 text-white dark:text-neutral-900 no-underline rounded-lg text-sm transition-colors hover:bg-neutral-700 dark:hover:bg-neutral-300" target="_blank">
                  <AppleIcon /> App Store
                </a>
                <a href="https://play.google.com/store/apps/details?id=com.nottldr.app.android" class="flex items-center justify-center gap-1.5 px-4 py-2 bg-neutral-900 dark:bg-neutral-200 text-white dark:text-neutral-900 no-underline rounded-lg text-sm transition-colors hover:bg-neutral-700 dark:hover:bg-neutral-300" target="_blank">
            ...
            <div class="bg-neutral-50 dark:bg-neutral-900 rounded-xl px-4 py-8 border border-neutral-200 dark:border-neutral-700 transition-all hover:shadow-lg hover:shadow-black/5 dark:hover:shadow-black/30 hover:-translate-y-0.5">
              ...
              <div class="flex flex-col gap-3">
                <a href="https://www.tasquito.com" class="flex items-center justify-center gap-1.5 px-4 py-2 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-200 border border-neutral-300 dark:border-neutral-600 no-underline rounded-lg text-sm transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-700" target="_blank">
                  Web
                </a>
            ...
            <div class="bg-neutral-50 dark:bg-neutral-900 rounded-xl px-4 py-8 border border-neutral-200 dark:border-neutral-700 transition-all hover:shadow-lg hover:shadow-black/5 dark:hover:shadow-black/30 hover:-translate-y-0.5">
              ...
              <div class="flex flex-col gap-3">
                <a href="https://www.networthmonitor.com" class="flex items-center justify-center gap-1.5 px-4 py-2 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-200 border border-neutral-300 dark:border-neutral-600 no-underline rounded-lg text-sm transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-700" target="_blank">
                  Web
                </a>
                <div class="flex items-center gap-3 text-xs text-neutral-400 dark:text-neutral-600 my-1 before:content-[''] before:flex-1 before:h-px before:bg-neutral-300 dark:before:bg-neutral-600 after:content-[''] after:flex-1 after:h-px after:bg-neutral-300 dark:after:bg-neutral-600">
                  Coming Soon
