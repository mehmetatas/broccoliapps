export const PrivacyPage = () => {
  return (
    <article class="max-w-2xl mx-auto p-8 bg-white/90 dark:bg-neutral-800/90 rounded-lg shadow-md dark:shadow-black/30">
      ...
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">When you create an account using Sign in with Google or Sign in with Apple, we collect:</p>
      <ul class="my-4 ml-6 text-neutral-600 dark:text-neutral-300 leading-relaxed list-disc">
      ...
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">We store the data you create within our apps, such as content, entries, and preferences you choose to save.</p>

      <h3 class="text-neutral-600 dark:text-neutral-400 text-lg mt-6 mb-3 font-bold">Technical Information</h3>
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">Our servers automatically collect standard technical information when you use our services:</p>
      <ul class="my-4 ml-6 text-neutral-600 dark:text-neutral-300 leading-relaxed list-disc">
      ...
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">We do not use your data for advertising, profiling, or any purpose other than providing our services.</p>
      ...
      <table class="w-full border-collapse my-4">
        <thead>
          <tr>
            <th class="p-3 text-left border-b border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-700 font-semibold text-neutral-800 dark:text-neutral-200">Service</th>
            <th class="p-3 text-left border-b border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-700 font-semibold text-neutral-800 dark:text-neutral-200">Purpose</th>
            <th class="p-3 text-left border-b border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-700 font-semibold text-neutral-800 dark:text-neutral-200">Data Shared</th>
          </tr>
        </thead>
        <tbody>
          <tr>
          ...
          <tr>
            ...
            <td class="p-3 border-b border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300">Payment processing (web/Android tips)</td>
            <td class="p-3 border-b border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300">Payment details (handled directly by Stripe)</td>
          </tr>
          <tr>
            ...
            <td class="p-3 border-b border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300">Payment details (handled directly by Apple)</td>
          </tr>
        </tbody>
      </table>
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">We do not sell, rent, or share your personal information with any other third parties.</p>
