  ...
  return (
    <article class="max-w-2xl mx-auto p-8 bg-white/90 dark:bg-neutral-800/90 rounded-lg shadow-md dark:shadow-black/30">
      ...
      <p class="text-neutral-500 dark:text-neutral-500 mb-8 pb-4 border-b border-neutral-200 dark:border-neutral-700">
        <strong>Serophin</strong>
        <br />
        Last updated: February 2026
      </p>

      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">
        This Privacy Policy applies to the Serophin application and services operated by Broccoli Apps ("we", "us", "our"), available at serophin.com and
      ...
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">
        We store the data you create within Serophin, such as your meditation preferences, session history, and purchase records.
      </p>
      ...
      <ul class="my-4 ml-6 text-neutral-600 dark:text-neutral-300 leading-relaxed list-disc">
        ...
        <li class="mb-2">Authenticate your account</li>
        <li class="mb-2">Sync your preferences and purchase status across devices</li>
        <li class="mb-2">Debug and improve our app</li>
      </ul>
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">
      ...
      <table class="w-full border-collapse my-4">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="p-3 border-b border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300">In-app purchases (iOS)</td>
          ...
          <tr>
            <td class="p-3 border-b border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300">Google</td>
            <td class="p-3 border-b border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300">In-app purchases (Android)</td>
            <td class="p-3 border-b border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300">
              Payment details (handled directly by Google)
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">
        You can delete your data within the app through its settings. Deleted data is permanently removed within 30 days.
      </p>
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">
        To delete all your data, please contact us at{" "}
        <a href="mailto:contact@broccoliapps.com" class="text-indigo-600 dark:text-indigo-400 no-underline hover:underline">
      ...
      <p class="text-neutral-600 dark:text-neutral-300 leading-relaxed mb-4">We do not use cookies on our website or app.</p>
